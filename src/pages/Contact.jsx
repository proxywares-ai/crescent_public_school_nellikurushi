...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        "service_88pb8bf",   // from EmailJS
        "template_h237g1l",  // from EmailJS
        formData,
        "ejVooU2diqzd-B_U0"    // from EmailJS
      )
      .then(
        (result) => {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-white shadow-lg rounded-2xl p-6">
                ...
                <ul className="space-y-3">
                  <li>
                     <span className="text-gray-700">Nellikurissi, Ottapalam, Palakkad, Kerala</span>
                  </li>
                  <li> <span className="text-gray-700">+91 1234567890</span></li>
                  <li> <span className="text-gray-700">crescentpublicschool@gmail.com</span></li>
                </ul>
