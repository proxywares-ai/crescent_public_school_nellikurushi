...
const HeroSection = () => (
  <>
    <div className="relative md:h-screen h-screen ">
      ...
      <div className="absolute inset-0  flex flex-col justify-center items-center text-white bottom-30 ">
        <h1 className="top-1/2 text-6xl font-bold ">CRESCENT PUBLIC SCHOOL</h1>
        <p className="top-1/2 text-lg ">Learning Today, Leading Tomorrow</p>
      </div>
    </div>
  </>
);
